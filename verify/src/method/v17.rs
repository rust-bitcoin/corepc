...
pub const METHODS: &[Method] = &[
    ...
    // network
    Method::new_no_model("addnode", "AddNode", "add_node"),
    Method::new_no_model("clearbanned", "ClearBanned", "clear_banned"),
    Method::new_no_model("disconnectnode", "DisconnectNode", "disconnect_node"),
    ...
    Method::new_no_model("ping", "Ping", "ping"),
    Method::new_no_model("setban", "SetBan", "set_ban"),
