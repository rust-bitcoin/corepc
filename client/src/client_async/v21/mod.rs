...
//! An async JSON-RPC client for Bitcoin Core `v0.21`.
...
crate::define_jsonrpc_bitreq_async_client!("v21");
crate::impl_async_client_check_expected_server_version!({ [210200] });
