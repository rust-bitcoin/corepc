...
//! An async JSON-RPC client for Bitcoin Core `v0.19`.
...
crate::define_jsonrpc_bitreq_async_client!("v19");
crate::impl_async_client_check_expected_server_version!({ [190100] });
