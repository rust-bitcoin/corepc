...
//! An async JSON-RPC client for Bitcoin Core `v27`.
...
crate::define_jsonrpc_bitreq_async_client!("v27");
crate::impl_async_client_check_expected_server_version!({ [270000, 270100, 270200] });
