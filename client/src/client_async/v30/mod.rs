...
//! An async JSON-RPC client for Bitcoin Core `v30`.
...
crate::define_jsonrpc_bitreq_async_client!("v30");
crate::impl_async_client_check_expected_server_version!({ [300000, 300100, 300200] });
