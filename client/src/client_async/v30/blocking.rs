...
//! Auto-generated blocking facade for Bitcoin Core `30`.
//!
//! Generated by `codegen`. Do not edit by hand, re-run `just codegen` to regenerate.
//!
//! Exposes the same method surface as the sync client `crate::client_sync::v30` by
...
/// `test-async`. Mirrors `crate::types::v30` (the curated types the facade's macro
...
/// A blocking JSON-RPC client that drives the async `v30` production client.
pub struct Client {
