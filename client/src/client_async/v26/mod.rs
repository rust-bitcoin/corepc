...
//! An async JSON-RPC client for Bitcoin Core `v26`.
...
crate::define_jsonrpc_bitreq_async_client!("v26");
crate::impl_async_client_check_expected_server_version!({ [260000, 260100, 260200] });
