...
SOCKS5 targets are encoded per RFC 1928: IPv4 and IPv6 literals with
their native ATYP, hostnames as domain names (ATYP 0x03) with DNS
resolution left to the proxy. The latter is required for `.onion`
routing through Tor.
