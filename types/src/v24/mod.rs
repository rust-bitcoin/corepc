...
pub use crate::{
    v17::{
        ...
        Locked, PeerInfo, RescanBlockchain, SendMany, SendRawTransaction, SendToAddress, SetHdSeed,
        SetTxFee, SignErrorData, SignMessage, SignRawTransactionWithWallet, SoftforkReject,
        TransactionCategory, UploadTarget, VerifyChain, VerifyTxOutProof, WalletCreateFundedPsbt,
        WalletLock, WalletPassPhrase, WalletPassPhraseChange, WalletProcessPsbt,
    },
    ...
    v21::UnloadWallet,
    v22::{GetTxOut, GetTxOutError, Logging, ScanTxOutSet, ScanTxOutSetStatus, ScriptPubkey},
    v23::SaveMempool,
};
