...
use bitcoin::{
    ...
    RedeemScriptBuf, ScriptPubKeyBuf, SignedAmount, Transaction, Txid, WitnessProgram,
    WitnessVersion,
};
...
pub struct AddMultisigAddress {
    ...
    pub redeem_script: RedeemScriptBuf,
...
pub struct GetAddressInfo {
    ...
    pub hex: Option<RedeemScriptBuf>,
...
pub struct GetBalance(#[serde(with = "bitcoin::amount::serde::as_sat")] pub Amount);
...
#[derive(Clone, Debug, PartialEq, Deserialize, Serialize)]
pub struct GetReceivedByAddress(#[serde(with = "bitcoin::amount::serde::as_sat")] pub Amount);

/// Models the result of JSON-RPC method `getreceivedbylabel`.
#[derive(Clone, Debug, PartialEq, Deserialize, Serialize)]
pub struct GetReceivedByLabel(#[serde(with = "bitcoin::amount::serde::as_sat")] pub Amount);
...
#[derive(Clone, Debug, PartialEq, Deserialize, Serialize)]
pub struct GetUnconfirmedBalance(#[serde(with = "bitcoin::amount::serde::as_sat")] pub Amount);
