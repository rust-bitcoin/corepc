    ...
    pub fn into_model(self) -> Result<model::GetWalletInfo, GetWalletInfoError> {
        ...
        Ok(model::GetWalletInfo {
            ...
            unlocked_until: self
                ...
                .transpose()?,
            pay_tx_fee: crate::btc_per_kb(self.pay_tx_fee).map_err(E::PayTxFee)?,
...
pub enum GetWalletInfoError {
    ...
    PayTxFee(amount::ParseAmountError),
...
impl fmt::Display for GetWalletInfoError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            Self::PayTxFee(ref e) => write_err!(f, "conversion of the `PayTxFee` field failed"; e),
    ...
    pub fn into_model(self) -> Result<model::ListSinceBlock, ListSinceBlockError> {
        ...
        Ok(model::ListSinceBlock {
            ...
            removed: self
                ...
                .into_iter()
                .map(|v| {
                    serde_json::from_value::<ListSinceBlockTransactionsItem>(v)
                        .map_err(E::Removed)?
                        .into_model()
                        .map_err(E::RemovedItem)
                })
                .collect::<Result<Vec<_>, _>>()?,
...
pub enum ListSinceBlockError {
    ...
    Removed(serde_json::Error),
    /// Conversion of the `RemovedItem` field failed.
    RemovedItem(TransactionItemError),
...
impl fmt::Display for ListSinceBlockError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Self::RemovedItem(ref e) =>
                write_err!(f, "conversion of the `RemovedItem` field failed"; e),
