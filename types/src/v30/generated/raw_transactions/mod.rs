...
//! Auto-generated types for Bitcoin Core `30` - rawtransactions.
//!
...
pub use self::into::{
    AnalyzePsbtError, AnalyzePsbtInputError, AnalyzePsbtInputMissingError, CombinePsbtError,
    CombineRawTransactionError, ConvertToPsbtError, CreatePsbtError, CreateRawTransactionError,
    DecodePsbtError, DecodeRawTransactionError, DecodeScriptError, DescriptorProcessPsbtError,
    FinalizePsbtError, FundRawTransactionError, GetRawTransactionError,
    GetRawTransactionVerboseError, JoinPsbtsError, MempoolAcceptanceError,
    MempoolAcceptanceFeesError, SendRawTransactionError, SignFailError, SignRawTransactionError,
    SubmitPackageError, SubmitPackageTxResultError, SubmitPackageTxResultFeesError,
    TestMempoolAcceptError, UtxoUpdatePsbtError,
};
